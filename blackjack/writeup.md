...
- This one should be kinda easy, just one point - let's see what we have here
- The callanges says "I like to give my flags to millionares. how much money you got?" - I probably need to win a lot of money
- I get this link: http://cboard.cprogramming.com/c-programming/114023-simple-blackjack-program.html
	+ It holds the implemintation of a blackjack game
	+ I can connect with `nc pwnable.kr 9009` to play the game
- To be honest I can see a comment that is probably pointing out a bug in the code, let's not read it now haha
- This is the code:
```c
